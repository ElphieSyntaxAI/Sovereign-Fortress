...
- [`docs/msgf/technical-specs/MSGF_BRAIN_ROUTING.md`](../../msgf/technical-specs/MSGF_BRAIN_ROUTING.md) — Small Brain savings
- [`docs/msgf/technical-specs/MSGF_SHADOW_PROXY.md`](../../msgf/technical-specs/MSGF_SHADOW_PROXY.md) — Shadow / Active gateway
- [`docs/msgf/MSGF_RC_CHECKLIST.md`](../../msgf/MSGF_RC_CHECKLIST.md) — RC gates
- [`docs/author-ecosystem/AUTHOR_ECOSYSTEM_ROADMAP.md`](../../author-ecosystem/AUTHOR_ECOSYSTEM_ROADMAP.md) — product phases
