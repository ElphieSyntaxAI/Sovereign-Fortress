...
| **MSGF 1.0 release plan** | Acceptance criteria, repo map | [`docs/MSGF_V1_ROADMAP.md`](./MSGF_V1_ROADMAP.md) |
...
| **P6 — Constraint Ledger** | Compliance regression, error history, hallucination avoidance | **Vault** (success) vs **Hall** (failure); **CROSS-REF** | [`packages/msgf/lib/msgf-shadow.ts`](../packages/msgf/lib/msgf-shadow.ts), [`packages/msgf/lib/msgf-index.ts`](../packages/msgf/lib/msgf-index.ts), [`packages/msgf/lib/services/constraint-ledger.ts`](../packages/msgf/lib/services/constraint-ledger.ts), [`packages/msgf/lib/schemas/vault-hall-metadata.ts`](../packages/msgf/lib/schemas/vault-hall-metadata.ts) | `pillar_vectors`, `msgf_sandbox`, `p4_narrative_library_chunks` (semantic cold) |
...
| **DEFEND** | Shadow + LOM | [`msgf-shadow.ts`](../packages/msgf/lib/msgf-shadow.ts), Pulse + ingest gates |
