...
**Engineering pillar numbers:** [`../MSGF_PILLAR_MAPPING_SSOT.md`](../../msgf/technical-specs/MSGF_PILLAR_MAPPING_SSOT.md) — **master-spec P1–P6 win** over education-only nicknames.
