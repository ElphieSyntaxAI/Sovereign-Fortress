...
**Platform pillar SSOT:** [`../MSGF_PILLAR_MAPPING_SSOT.md`](../../msgf/technical-specs/MSGF_PILLAR_MAPPING_SSOT.md)
...
- Author Ecosystem or MSGF Gated AI product specs → see `docs/author-ecosystem/AUTHOR_ECOSYSTEM_ROADMAP.md`, `docs/msgf/MSGF_V1_ROADMAP.md`
