...
**Contrast:** [`MSGF_SOLO_INTEGRATION.md`](./MSGF_SOLO_INTEGRATION.md) is for **third-party apps** calling MSGF with `msgf_live_…` keys. This doc is for **you** using the MSGF web product.
