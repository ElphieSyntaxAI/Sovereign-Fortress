...
-- =============================================================================
-- Correct DealStar operator email domain (.io). Prior migration used .com by mistake.
...
BEGIN
  ...
  IF v_user_id IS NULL THEN
    RAISE NOTICE
      'promote_jessica_dealstar_io_global_admin: % not in auth.users — run create:platform-admin',
      v_email;
    RETURN;
  END IF;
